...
export class TransporteService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/transportes';
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ITransporte[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
