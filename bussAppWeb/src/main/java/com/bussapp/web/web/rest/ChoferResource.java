...
import com.bussapp.web.repository.search.ChoferSearchRepository;
...
public class ChoferResource {
    ...
    private final ChoferSearchRepository choferSearchRepository;

    public ChoferResource(ChoferRepository choferRepository, ChoferSearchRepository choferSearchRepository) {
        this.choferRepository = choferRepository;
        this.choferSearchRepository = choferSearchRepository;
    }
    ...
    public ResponseEntity<Chofer> createChofer(@RequestBody Chofer chofer) throws URISyntaxException {
        ...
        choferSearchRepository.save(result);
    ...
    public ResponseEntity<Void> deleteChofer(@PathVariable Long id) {
        ...
        choferSearchRepository.deleteById(id);
        return ResponseEntity.noContent().headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, ENTITY_NAME, id.toString())).build();
    }

    /**
     * {@code SEARCH  /_search/chofers?query=:query} : search for the chofer corresponding
     * to the query.
     *
     * @param query the query of the chofer search.
     * @return the result of the search.
     */
    @GetMapping("/_search/chofers")
    public List<Chofer> searchChofers(@RequestParam String query) {
        log.debug("REST request to search Chofers for query {}", query);
        return StreamSupport
            .stream(choferSearchRepository.search(queryStringQuery(query)).spliterator(), false)
