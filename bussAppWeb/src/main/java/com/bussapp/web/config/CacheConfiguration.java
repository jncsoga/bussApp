package com.bussapp.web.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bussapp.web.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bussapp.web.repository.UserRepository.USERS_BY_EMAIL_CACHE);
